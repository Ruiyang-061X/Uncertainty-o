...
class InternVL:
    ...
    def generate(self, in_modal, out_modal, data, temp):
        pixel_values = load_image(data['image'], max_num=4).to(torch.bfloat16).to(0)
...
if __name__ == "__main__":
    mllm = InternVL()
    data = {
        'image': '/data/lab/yan/huzhang/huzhang1/code/Uncertainty-o1/image.png',
        'text': {
            'question': 'Parse text in this image.',
        }
    }
    print(data)
    ans = mllm.generate(
