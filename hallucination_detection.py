...
def batch_process(args, mllm, benchmark, mllm_captioner, llm):
    ...
    log_dict['ground_truth_list'] = ground_truth_list
    log_dict['uncertainty_list'] = uncertainty_list
    log_dict['AUROC'] = compute_auroc(ground_truth_list, uncertainty_list)
    log_dict['AURAC'] = compute_aurac(ground_truth_list, uncertainty_list)
    log_dict['ECE'] = compute_ece(ground_truth_list, uncertainty_list)
